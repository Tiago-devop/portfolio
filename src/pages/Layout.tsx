    ...
    <div className="relative container min-h-screen flex mx-auto bg-[#10121A] text-white font-mono">
      <nav className="md:flex hidden flex-col items-center box-border border-r border-white w-80 p-4">
        ...
        <div className='flex w-24 my-10 justify-around'>
          <ImgWithTooltip src={Brazil} alt="Portuguese" />
      ...
      <label className="md:hidden absolute top-1 left-1 btn btn-circle swap swap-rotate bg-[#191e24] hover:bg-[#323b47] border-none">
        ...
        <svg className="swap-off fill-[#a6adbb]" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><path d="M64,384H448V341.33H64Zm0-106.67H448V234.67H64ZM64,128v42.67H448V128Z" /></svg>
      ...
      {checked && (
        <div className='md:hidden absolute inset-0 flex justify-center items-center' onClick={() => setChecked(toggle)}>
          <div className='w-full h-full bg-black bg-opacity-90 flex justify-center items-start z-50'>
            <div className='flex flex-col justify-around items-center mt-[100px] gap-4'>
